...
sgm_optim_1.write(inL_offs,Image_buf_phy_addr+10*image_size)
sgm_optim_1.write(inR_offs,Image_buf_phy_addr+11*image_size)
sgm_optim_1.write(outD_offs,Image_buf_phy_addr+12*image_size)
sgm_optim_0.write(inL_offs,Image_buf_phy_addr+10*image_size+ADDRESS_OFFSET)
sgm_optim_0.write(inR_offs,Image_buf_phy_addr+11*image_size+ADDRESS_OFFSET)
sgm_optim_0.write(outD_offs,Image_buf_phy_addr+12*image_size+ADDRESS_OFFSET)
