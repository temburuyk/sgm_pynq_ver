...
overlay = Overlay('/home/xilinx/sgm_pynq_ver/sad_bitstream/design_1.bit')
overlay
...
#sgm offsets
LeftIm_offs = SGM_GreyCost_0.register_map.LeftIm.address
RightIm_offs = SGM_GreyCost_0.register_map.RightIm.address
DispIm_offs = SGM_GreyCost_0.register_map.DispIm.address
...
SGM_GreyCost_0.write(LeftIm_offs,Image_buf_phy_addr+10*image_size)
SGM_GreyCost_0.write(RightIm_offs,Image_buf_phy_addr+11*image_size)
SGM_GreyCost_0.write(DispIm_offs,Image_buf_phy_addr+12*image_size)
